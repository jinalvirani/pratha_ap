            ...
            <div class="col-md-12">
                <div class="ibox-content">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12">
                            <form class="m-t" role="form" action="<?php echo base_url(); ?>admin_controller/reset_password_cont" method="post"><?php if($invalid = $this->session->flashdata('repassword_error')) { ?>
                                    <div class="row">
                                        <div class="col-sm-12">
								...
								<a href="<?php echo base_url(); ?>admin_controller/index"><small>go to login page</small></a>
								</div>
                            </form>
                        </div>
                    </div>
