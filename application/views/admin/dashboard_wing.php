...
<body>
    ...
    <?php include('dashboard_index.php'); ?>  
        <!-- =======================================table================================= -->
        <?php if($invalid = $this->session->flashdata('wing_insert')) { ?>
                ...
                <?php echo $invalid; ?>
                        ...
                        <?php } ?>
        <?php if($invalid = $this->session->flashdata('wing_delete')) { ?> 
                       <div class="ibox float-e-margins" id="abc">
                <div class="ibox-title" style="background-color:#b9b624">
                <a class="close-link pull-right"><i class="fa fa-times" style="color:black"></i></a>
                <?php echo $invalid; ?>
        ...
        <div class="wrapper wrapper-content animated fadeInRight">
            <div class="row">
                ...
                <div class="ibox float-e-margins">
                    ...
                    <div class="">
                   <a href="<?php echo base_url();?>admin_controller/add_wing_cont" class="btn btn-add btn-primary pull-right col-sm-2" >+ Add Wing</a>
                    </div>   
...
<tbody>         
                ...
                ?>
                    <tr>
                        ...
                        <td width="50px" height="50px"><center><a href="<?php echo base_url(); ?>/admin_controller/dashboard_wing_cont?wing_id=<?php echo $w->wing_id; ?>"><img src="<?php echo base_url(); ?>img/delete.png" height="50%" width="50%" onclick="return del()">Delete</a></center></td>
                    </tr>
                <?php
                    } }
                ?>
