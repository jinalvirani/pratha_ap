...
<head>
    ...
    <title>ADMIN LOGIN | PRATHA</title>
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="ibox-content">
                    <form class="m-t" role="form" action="<?php echo  base_url(); ?>admin_controller/adminlogin_cont" method="post">
						...
						<small>Forgot password?
							<a href="<?php echo base_url(); ?>admin_controller/forgotpassword_index_cont">
							Click Hear!
                        </a></small>
                    </form>
                    <p class="m-t">
