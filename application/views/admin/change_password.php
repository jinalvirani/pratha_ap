            ...
            <div class="col-md-12">
                <div class="ibox-content">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12">
                            <form class="m-t" role="form" action="<?php echo base_url();?>admin_controller/adminprofile_cont" method="post">
								...
								<!--<a href="admin_login.php"><small>Go To Login Page</small></a>-->
								</div>
								<a href="<?php echo base_url(); ?>admin_controller/forgotpassword_cont"><small>Forgot Password?</small></a>
                            </form>
                        </div>
                    </div>
                </div>
