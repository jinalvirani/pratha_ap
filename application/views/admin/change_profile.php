...
<head>
    ...
    <title>CHNGE PROFILE | PRATHA</title>
            ...
            <div class="col-md-12">
                <div class="ibox-content">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12">
                            <form class="m-t" role="form" action="<?php echo base_url(); ?>admin_controller/adminedit_cont" method="post" enctype="multipart/form-data" id="form1">
                ...
                <div class="form-group"><label>Admin Pic</label>
                                ...
                                <?php } ?>
                                        ...
                                        <?php if(isset($ut->pic)) { ?>
                                        <div id="realimg">
                                        <img src="<?php echo base_url(); ?>img/admin/<?php echo $pic; ?>" height="100px" width="100px" class="img-responsive">
                                        </div>
                                        <?php } ?>
