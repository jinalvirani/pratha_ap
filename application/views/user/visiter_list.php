            ...
            <div class="row">
                ...
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        <h5>Display All Visitor</h5>
                       
                    </div>
					<div class="ibox-content">
					<div class="">
					<a href="<?php echo base_url(); ?>owner_controller/staff_attendence_cont" class="btn btn-add btn-primary pull-right col-sm-2" >Check Staff Attendence</a>
         </div>
         <div clas="">
