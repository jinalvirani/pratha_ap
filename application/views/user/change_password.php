            ...
            <div class="col-md-12">
                <div class="ibox-content">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12">
                            <form class="m-t" role="form" action="<?php echo base_url();?>owner_controller/ownerprofile_cont" method="post">
                                ...
                                <a href="<?php echo base_url(); ?>owner_controller/forgotpassword_cont"><small>Forgot Password?</small></a>
                            </form>
                        </div>
                    </div>
                </div>
