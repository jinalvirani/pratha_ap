            ...
            <div class="col-md-12">
                <div class="ibox-content">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12">
                            <form class="m-t" role="form" action="<?php echo base_url(); ?>owner_controller/changeprofile_cont" method="post" enctype="multipart/form-data" id="form1">
                                <?php if($invalid = $this->session->flashdata('change_profile')) { ?>
                                    <div class="row">
                                        <div class="col-sm-12">
                ...
                <div class="form-group"><label>User Pic</label>
                                ...
                                <?php } ?>
                                        ...
                                        <?php if(isset($ut->pic)) { ?>
                                        <div id="realimg">
                                        <img src="<?php echo base_url(); ?>img/owner/<?php echo $pic; ?>" height="100px" width="100px" class="img-responsive">
                                        </div>
                                        <?php } ?>
