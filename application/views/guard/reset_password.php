            ...
            <div class="col-md-12">
                <div class="ibox-content">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12">
                            <form class="m-t" role="form" action="<?php echo base_url(); ?>guard_controller/reset_password_cont" method="post"><?php if($invalid = $this->session->flashdata('repassword_error')) { ?>
                                    <div class="row">
                                        <div class="col-sm-12">
