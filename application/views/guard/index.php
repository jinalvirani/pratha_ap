...
<head>
    ...
    <title>SECURITY GUARD LOGIN | PRATHA</title>
...
<body class="gray-bg">
    ...
    <div class="loginColumns animated fadeInDown" style="padding-top: 10px;">
        <div class="row">
            <div class="col-md-6">
                 <h2 class="font-bold">SECURITY GUARD LOGIN</h2>
                <hr>
                <div class="img-logo">
            ...
            <div class="col-md-6">
                <div class="ibox-content">
                    <form class="m-t" role="form" action="<?php echo  base_url(); ?>guard_controller/guardlogin_cont" method="post">
                        ...
                        <small>Forgot password?
                            <a href="<?php echo base_url(); ?>guard_controller/forgotpassword_index_cont">
                            Click Hear!
                        </a></small>
                    </form>
                    <p class="m-t">
